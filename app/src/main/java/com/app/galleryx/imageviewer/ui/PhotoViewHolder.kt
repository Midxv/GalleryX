...
import com.app.galleryx.imageviewer.ui.compose.PhotoViewHolderContent
import com.app.galleryx.model.database.entity.Photo
import com.app.galleryx.other.*
...
class PhotoViewHolder(
    ...
    private fun openVideoPlayer(photo: Photo) {
        val args = bundleOf(IntentParams.PHOTO_UUID to photo.uuid)
