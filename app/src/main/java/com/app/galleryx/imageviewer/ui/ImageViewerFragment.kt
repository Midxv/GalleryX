...
import com.app.galleryx.databinding.FragmentImageViewerBinding
import com.app.galleryx.imageloading.di.EncryptedImageLoader
import com.app.galleryx.other.extensions.addSystemUIVisibilityListener
...
import com.app.galleryx.other.extensions.showSystemUI
...
class ImageViewerFragment :
    ...
    override fun onDestroyView() {
        // SECURITY / PERF: Detach the adapter to prevent massive memory leaks
        binding.viewPhotoViewPager.adapter = null
        super.onDestroyView()
    }
