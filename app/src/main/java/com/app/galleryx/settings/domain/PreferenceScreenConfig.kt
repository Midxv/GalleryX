...
package com.app.galleryx.settings.domain
...
import com.app.galleryx.settings.data.Config.Companion.SECURITY_BIOMETRIC_AUTHENTICATION_ENABLED_DEFAULT
import com.app.galleryx.settings.data.Config.Companion.SYSTEM_DESIGN
